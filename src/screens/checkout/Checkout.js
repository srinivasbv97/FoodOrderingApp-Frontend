...
//Get state values to fill the dropdown
getStates(){
const url = baseURL + 'states'
const that = this;

//API call to for Utils.js
Utils.makeApiCall(
  url, 
  null,
  null,
...
//Invoke GET calls once the component successfully loads
componentDidMount(){
this.mounted = true;
}
...
//change of payment method value
handleChange = (event) => {
...
//parameters to pass in the API Url
